...
const 全部 = [
  ...
  ['事件四（跑团 + 开小游戏整条链路）', 'tools/事件四验收.mjs', 游戏, []],
  ['道具 vs 墙 / 挡门', '工具/查压墙.mjs', 根, []],
  ['座位表 vs 道具表（别有空座位）', '工具/查座位.mjs', 根, []],
  ['通道有没有被家具堵死', '工具/查挡路.mjs', 根, []],
  ...
  ['微信开关（Tab 不被强制关闭）', 'tools/微信开关体检.mjs', 游戏, []],
  ['坐姿（工位背面/茶水间正面）', 'tools/坐姿体检.mjs', 游戏, []],
  ['空格优先级（工位=椅子+主线入口）', 'tools/空格优先级体检.mjs', 游戏, []],
  ['NPC 传送（切房间人先到位）', 'tools/传送体检.mjs', 游戏, []],
